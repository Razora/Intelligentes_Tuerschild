...
\section{Bedienung der Verwaltungsapplikation auf dem Tablet}
  ...
  \subsection{Standby-Service konfigurieren}
    ...
    \end{itemize}
    In der verbleibenden Zeitspanne, muss nun endgültig die PhotoFrameApp gestartet und die Diashow ausgeführt werden. Daraufhin ist das Tablet nun so konfiguriert, das es sich mit dem gewählten Verzeichnis synchronisiert, eine Diashow dessen Inhalt ausgeben wird, es nicht von unbefugten benutzt werden kann und es sich zu bestimmten Zeiten in den Standbymodus versetzt und darauf auch wieder erwacht.
\end{flushleft}
