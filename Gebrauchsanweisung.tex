...
\begin{itemize}
  \item Klicken sie auf den Button ``Vorlage wählen''.
    \subitem Es öffnet sich nun ein Dialog für die Auswahl einer Bilddatei. Um ein optimales Ergebnis zu erzielen, wählen Sie eine Datei mit einer Auflösung von 800x400 Pixeln. Diese wird später der Hintergrund sein, auf dem sich die Nachricht befindet. Bestätigen Sie ihre Auswahl mit ``öffnen''.
...
\section{Bedienung der Verwaltungsapplikation auf dem Tablet}
  ...
  Die PCFileSync-Applikation dient dazu, ein bestimmtes Verzeichnis mit einer entsprechenden Netzwerkfreigabe, die in diesem Projekt über das SMB-Protokoll realisiert wird, zu synchronisieren.
    \begin{itemize}
      ...
      \begin{figure}[htb]
        \centering
        \includegraphics[width=.5\textwidth]{pcfilsync_conf2.png}\\ % PNG-File
      \end{figure}
