...
\section{Bedienung der Verwaltungsapplikation auf dem Tablet}
  ...
  \subsection{Konfiguration der Applikation - ScreenOff}
    ...
    Die Konfiguration von ScreenOff, ist eigentlich nur eine Aktivierung dieser. Die Applikation benötigt die freigabe als Geräteadministrator. Man muss hierbei die App nur zweimal starten und zwar über den Button ´´Configure ScreenOff!''. Beim ersten mal werden einige Hinweise gegeben, diese kann man mit ´´OK'' bestätigen. Das zweite mal wird gefragt ob die Applikation Geräteadministrator werden darf, was man mit ´´Aktivieren'' bestätigen muss.
    Daraufhin ist die Applikation ordnungsgemäß aktiviert. Falls man die funktionalität prüfen will, kann  man einfach noch mal auf den entsprechenden Button drücken wodrauf das Tablet den Bildschirm ausschalten sollte.
